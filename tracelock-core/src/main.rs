...
baselines::write_all_baseline_outputs("artifacts", 1_000_000, 10)
    .expect("failed to write baseline benchmark outputs");

println!("Wrote baseline benchmark CSV to artifacts/baseline_bench.csv");
println!("Wrote repeated benchmark CSV to artifacts/baseline_bench_repeated.csv");
println!("Wrote benchmark summary CSV to artifacts/baseline_bench_summary.csv");
}